...
let package = Package(
    ...
    dependencies: [
      ...
      .package(url: "https://github.com/pia-foss/mobile-ios-releases-regions.git", branch: "release/1.6.0"),
      .package(url: "git@github.com:pia-foss/mobile-ios-openvpn.git", branch: "master"),
      .package(url: "git@github.com:xvpn/cpz_pia-mobile_ios_pia-wireguard.git", branch: "1.1.0"),
